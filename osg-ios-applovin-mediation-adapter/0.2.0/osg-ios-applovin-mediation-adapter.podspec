Pod::Spec.new do |spec|
  ...
  spec.version          = '0.2.0'
  spec.summary          = 'AppLovin MAX adapter for OSG iOS SDK.'
  ...
  spec.source           = {
    :http => 'https://github.com/osg-inc/osg-ios-specs/raw/main/artifacts/osg-ios-applovin-mediation-adapter-0.2.0.zip',
    :type => 'zip'
  }
